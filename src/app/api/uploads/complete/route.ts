...
// AI summary integration temporarily removed here (2026-09-07) - uploads were
// failing to finalize after this was wired in, even for ineligible file types,
// suggesting the import/module load itself may be the problem on Vercel's
// runtime despite building cleanly locally. Re-add once root-caused.
